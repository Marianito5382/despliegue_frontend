...
export default function ProjectCard({ id, titulo, cuerpo }: Props) {
    return (
        <div className="border rounded-lg shadow-lg p-6 bg-gray-200 w-full md:w-2/3 lg:w-1/2 mx-auto my-4 transform transition-transform duration-300 hover:scale-105">
